...
const Activity = (props) => {
    ...
    return (
        <>  
            <div className="package-section-bg py-5 mb-5">
                <section className='container package-section ' >
                    <div className='d-flex flex-column align-items-center justify-content-center  '>
                        <h2 className='heading-text'>Explore Activities </h2>
                        <p className='small sub-heading-text'>Book Best Activity for you</p>
                    </div>
