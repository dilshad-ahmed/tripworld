...
const Flight = (props) => {
    ...
    return (
        <>  
            <section className='container package-section my-5' >
                <div className='d-flex flex-column align-items-center justify-content-center  '>
                    <h2 className='heading-text'>Explore Flights </h2>
                    <p className='small sub-heading-text'>Book Best Flights for you</p>
                </div>
